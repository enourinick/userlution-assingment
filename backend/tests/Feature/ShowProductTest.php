...
class ShowProductTest extends TestCase
{
    ...
    public function test_return_403_when_an_overaged_user_attempts_to_access_a_restricted_product(): void
    {
    ...
    public function test_return_the_product_when_an_overaged_user_attempts_to_access_an_unrestricted_product(): void
    {
        $user = User::factory()->overage()->create();
        $category = Category::factory()
            ->has(Product::factory())
